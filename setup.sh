...
echo ""
echo "📝 Next steps:"
echo "  1. For local CLI usage, install dependencies:"
echo "     - Using uv (recommended): uv pip install -r requirements.txt"
echo "     - Or using pip: pip install -r requirements.txt"
echo "  2. Use the CLI to add test data: python -m app.cli add --random"
echo "  3. Monitor events in Kafka UI: http://localhost:8080"
echo "  4. Check consumer logs: make logs-consumer"
echo ""
